...
const photographersCards = [
  ...
  {
    photographerName: "Max Lisovskiy",
    content: [
...
function Photographers() {
  return (
    <section className="photographers container" id="photographers">
      <Slider>
        {photographersCards.map((card, index) => (
          <SwiperSlide key={`photographersCard-${index}`}>
            <PhotographerCard
